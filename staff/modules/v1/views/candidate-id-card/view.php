    ...
    <head>
        ...
        <style>
            ...
            @font-face {
              ...
              font-style: normal;
              font-weight: 400;
              src: url(<?= Yii::getAlias("@web") ?>/fonts/Droid-Arabic-Kufi/DroidKufi-Regular.ttf) format('truetype');
            }
            ...
            @font-face {
              ...
              font-style: normal;
              font-weight: 700;
              src: url(<?= Yii::getAlias("@web") ?>/fonts/Droid-Arabic-Kufi/DroidKufi-Bold.ttf) format('truetype');
            }
            ...
            .front-card {width:638px; height:1011px; float:left;margin-bottom: 100px;}
            .top-part{background: #3D4AB8;min-height:599px;text-align: center;position: relative;}
            .code{position: absolute;left: 10px;writing-mode: vertical-rl;text-orientation: mixed;top: 30px;font-size: 36px;letter-spacing: normal;color: #ffffff;}
            .image{width: 319px; height: 319px;overflow: hidden;border-radius: 50%;position: absolute;top: 98px;left: calc((100% - 319px)/2);border: 5px solid #fff;}
            .name-top{position: absolute; right: 69px; bottom: 25px;   font-size: 64px;   font-weight: bold;   font-stretch: normal;   font-style: normal;   line-height: normal;   letter-spacing: normal;   color: #ffffff;}
            .name-bottom{position: absolute; right: 69px; top: 25px;  font-size: 55px;  font-stretch: normal;   font-style: normal;   line-height: normal;   letter-spacing: normal;   color: #000000;}
