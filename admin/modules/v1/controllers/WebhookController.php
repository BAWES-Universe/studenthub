...
class WebhookController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        Yii::info('[Webhook Account Created] Webhook "'.$model->event.'" created by Admin: "'.Yii::$app->user->identity->admin_name.'"', __METHOD__);
    ...
    public function actionUpdate($id)
    {
        ...
        Yii::info('[Webhook Account Updated] Webhook "'.$model->event.'" updated by Admin: "'.Yii::$app->user->identity->admin_name.'"', __METHOD__);
