...
class DiscountController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        Yii::info('[Discount Created] Discount "' . $model->description_en . '" created by Admin: "' . Yii::$app->user->identity->admin_name . '"', __METHOD__);
    ...
    public function actionUpdate($id)
    {
        ...
        Yii::info('[Discount Updated] Discount "' . $model->description_en . '" updated by Admin: "' . Yii::$app->user->identity->admin_name . '"', __METHOD__);
    ...
    public function actionDelete($id)
    {
        ...
        Yii::info('[Discount Deleted] Discount "' . $discount->description_en . '" deleted by Admin: "' . Yii::$app->user->identity->admin_name . '"',
            __METHOD__);
