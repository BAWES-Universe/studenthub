 ...
 *
 * \common\components\PhpExcel::widget([
 *        'models' => $allModels,
 ...
 * ~~~
 *
 * $data = \common\components\PhpExcel::import($fileName, $config); // $config is an optional
 *
 * $data = \common\components\PhpExcel::widget([
 *        'mode' => 'import',
 *        'fileName' => $fileName,
 ...
 * ]);
 *
 * $data = \common\components\PhpExcel::import($fileName, [
 *        'setFirstRecordAsKeys' => true, // if you want to set the keys of record column with first record, if it not set, the header with use the alphabet column on excel.
 *        'setIndexSheetByName' => true, // set this if your excel data with multiple worksheet, the index of array will be set with the sheet name. If this not set, the index will use numeric.
 *        'getOnlySheet' => 'sheet1', // you can set this property if you want to get the specified sheet from the excel data with multiple worksheet.
 *    ]);
 ...
 * ]);
 *
 * $data = \common\components\PhpExcel::import([
 *            'file1' => $fileName1,
 *            'file2' => $fileName2,
 *            'file3' => $fileName3,
 *        ], [
 ...
 * @since 1
 */
class PhpExcel extends \yii\base\Widget
{
    // Border style
     ...
     * ~~~
     *
     * $data = \common\components\PhpExcel::import($fileName, ['setFirstRecordAsKeys' => true]);
     *
     * ~~~
     *
