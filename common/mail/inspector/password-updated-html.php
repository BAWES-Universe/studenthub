    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
      <head>
        <title>
          Your password reset was a success
        </title>
        <!--[if !mso]><!-- -->
    ...
    @media only screen and (max-width:480px) {
      ...
      />
            ...
            <tr>
              <td
                 align="left" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-bottom:20px;word-break:break-word;"
              >
      ...
      <div
         style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#000000;"
      >
        Of course, if you did not request this reset, then that's a problem we need to know about. Write to us immediately <a href='mailto:contact@studenthub.co'>here</a> and we'll get it sorted out.
      </div>
