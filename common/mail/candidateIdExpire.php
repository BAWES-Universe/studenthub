...
<div class="password-reset">
    ...
    <p>Candidate having invalid civil ID...</p>
    ...
    <table class="table table-bordered" style="width: 100%;  max-width: 500px;">
    	...
    	<tbody>
    		...
    		<tr>
    			<td align="left" style="border-left: 1px solid #ddd; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;"><?= $candidate->candidate_id ?></td>
    			<td align="left" style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;"><?= $candidate->candidate_name ?></td>
    			<td align="left" style="border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD;"><?= $candidate->candidate_email ?></td>
    		</tr>
    		<?php } ?>
    	</tbody>
    </table>
