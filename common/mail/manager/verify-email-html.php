...
$email = ($manager->new_email) ? $manager->new_email : $manager->emamil;

$webUrl = Yii::$app->params['managerAppUrl'] . 'verify-email/' . urlencode($email) . '/' . $manager->auth_key;

$mobileUrl = 'studenthub-manager://verify-email/' . urlencode($email) . '/' . $manager->auth_key;
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        Your verification code : <?= $manager->auth_key ?>
                                                    </div>
