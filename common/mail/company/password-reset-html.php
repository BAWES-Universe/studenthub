                                              ...
                                              <![endif]-->
                                                    ...
                                                    <div
                                                        ...
                                                        <table
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <div
                                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#000000;"
                                                                        >
                                                                        Somebody (hopefully you) requested a new password for the StudentHub account for <?= $email ?>. No changes have been made to your account yet.
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    align="left" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:8px;padding-right:30px;padding-bottom:13px;padding-left:30px;word-break:break-word;"
                                                                    >
                                                            ...
                                                            <tr>
                                                                <td
                                                                    align="left" style="font-size:0px;padding:10px 25px;padding-top:10px;padding-bottom:15px;word-break:break-word;"
                                                                    >
