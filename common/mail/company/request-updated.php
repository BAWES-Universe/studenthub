...
<head>
    <title>
        I've updated the request for Salesperson for Azadea
    </title>
    <!--[if !mso]><!-- -->
                                        ...
                                        >
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                            style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#000000;"
                                                    >
                                                        I've just updated the request made by <?=$model->contact->contact_name?> from <?=$company_name?>, the following are the changes I've made:
                                                    </div>

                                                </td>
                                            </tr>
                                            <?php foreach($changedParam as $param)  { ?>
                                            <tr>
                                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;padding-left:40px;word-break:break-word;">

                                                    <div style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:left;color:#000000;">
                                                        - <?=$param?>.
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:5px;word-break:break-word;">
                                                    ...
                                                    <div style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#000000;">
                                                        <?=Yii::$app->user->identity->staff_name?>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <tr>
                                                            ...
                                                            >
                                                                <a
                                                                        href="<?=$webUrl?>" style="background:#ffffff;color:#4C5DF2;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
                                                                >
