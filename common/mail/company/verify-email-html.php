...
$email = ($contact->contact_new_email) ? $contact->contact_new_email : $contact->contact_email;

$webUrl = Yii::$app->params['companyAppUrl'] . 'verify-email/' . urlencode($email) . '/' . $contact->contact_auth_key;

$mobileUrl = 'studenthub-employer://verify-email/' . urlencode($email) . '/' . $contact->contact_auth_key;
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        Your verification code : <?= $contact->contact_auth_key ?>
                                                    </div>
