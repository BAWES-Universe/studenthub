                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <tr>
                                                <td
                                                    align="left" style="font-size:0px;padding:10px 25px;padding-top:20px;padding-bottom:15px;word-break:break-word;"
                                                >
                                                    ...
                                                    >
                                                        Dear <?=$model->contact->contact_name?>,
                                                    </div>
                                            ...
                                            <tr>
                                                <td
                                                    align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:15px;word-break:break-word;"
                                                >

                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:24px;text-align:left;color:#000000;"
                                                    >
                                                        <?php  $type = ($model->request_position_type == 1) ? 'full-time' : 'part-time';  ?>
                                                        Kindly find the attached CVs for your <?=$type?> <?=$model->request_position_title?> position.
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:24px;text-align:left;color:#000000;"
                                                    >
                                                        The following are our notes on them:
                                                    </div>
...
<?php
                    ...
                    <div  style="Margin:0px auto;max-width:688px;">
                        ...
                        >
                            ...
                            <tr>
                                <td
                                        style="direction:ltr;font-size:0px;padding:0px;padding-left:40px;padding-right:40px;padding-top:15px;text-align:center;vertical-align:top;"
                                >
                                    <!--[if mso | IE]>
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                    class="" style="vertical-align:top;width:608px;"
                                            >
                                    <![endif]-->
                                    ...
                                    >
                                        ...
                                        >
                                            <tbody>
                                            <tr>
                                                <td  style="border:1px solid #d8e2e7;vertical-align:top;padding:10px;padding-right:0;padding-left:0;">
                                                    ...
                                                    >
                                                        ...
                                                        <tr>
                                                            <td
                                                                    align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:5px;word-break:break-word;"
                                                            >

                                                                <div
                                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;line-height:24px;text-align:left;color:#000000;"
                                                                >
                                                                    <?=$note->fulltimer->fulltimer_name?>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <?=$note->fulltimer->nationality->country_nationality_name_en?>
                                                                </div>

                                                            </td>
                                                        </tr>

                                                        <?php if ($note->fulltimer->area) { ?>
                                                            <tr>
                                                                <td
                                                                        align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;"
                                                                >
                                                                    ...
                                                                    <div
                                                                            style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:left;color:#444444;"
                                                                    >
                                                                        Currently staying in <?=$note->fulltimer->area->area_name_en?>,<?=$note->fulltimer->country->country_name_en?>
                                                                    </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <tr>
                                                <td
                                                    align="left" style="font-size:0px;padding:10px 25px;padding-top:15px;padding-bottom:0;word-break:break-word;"
                                                >
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:24px;text-align:left;color:#000000;"
                                                    >
                                                        Let us know if you’d like us to schedule their interviews.
                                                    </div>
                                            ...
                                            <tr>
                                                <td
                                                    align="left" style="font-size:0px;padding:10px 25px;padding-top:15px;padding-bottom:0px;word-break:break-word;"
                                                >
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        You can also view this requests details and provide feedback on our StudentHub employer portal.
                                                    </div>
                                            ...
                                            <tr>
                                                <td
                                                    align="left" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:8px;padding-right:30px;padding-bottom:20px;padding-left:22px;word-break:break-word;"
                                                >
                                                    ...
                                                    >
                                                        <tr>
                                                            <td
                                                                align="center" bgcolor="#ffffff" role="presentation" style="border:1px solid #4C5DF2;border-radius:5px;cursor:auto;padding:10px 25px;background:#ffffff;" valign="middle"
                                                            >
                                                                <a
                                                                    href="<?=Yii::$app->params['companyAppUrl'].'request-view/'.$model->request_uuid;?>" style="background:#ffffff;color:#4C5DF2;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
                                                                >
