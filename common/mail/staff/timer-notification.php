...
<div style="background-color:#4354a5;"><!--[if mso | IE]>
    ...
    <![endif]--><div style="margin:0px auto;max-width:700px;background:#d8e2e7;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#d8e2e7;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:1px;"><!--[if mso | IE]>
                    ...
                    <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;"><table role="presentation" cellpadding="0" cellspacing="0" style="background:white;" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;padding-top:30px;" align="center"><div style="cursor:auto;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:17px;line-height:22px;text-align:center;">
                                        ...
                                        You have not started the daily working timer. If you are working today then please go to staff app and login with your credential and start the timer & stop the timer after working hours
                                        ...
                                        For more detail please contact with CEO or CTO.
                                    </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:8px 16px 10px;padding-top:0px;padding-bottom:16px;padding-right:30px;padding-left:30px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:5px;color:white;cursor:auto;padding:10px 25px;" align="center" valign="middle" bgcolor="#00a8ff"><a href="https://staff.studenthub.co/" style="text-decoration:none;line-height:100%;background:#00a8ff;color:white;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:18px;font-weight:bold;text-transform:none;margin:0px;" target="_blank">
