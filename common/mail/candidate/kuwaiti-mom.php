...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    <title>
      Jobs in restaurants, cafes, and cinemas
    </title>
    <!--[if !mso]><!-- -->
...
@media only screen and (max-width:480px) {
  ...
  >
    <tbody>
      <tr>
        ...
        <tr>
          <td
             align="left" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-bottom:5px;word-break:break-word;"
          >
  ...
  >
      Dear <?=$name?>,
        ...
        <tr>
          <td
             align="left" style="font-size:0px;padding:10px 25px;padding-bottom:15px;word-break:break-word;"
          >

  <div
     style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#000000;"
  >
    We're currently working on legalizing part-time work in the food and beverage sector for non-Kuwaitis. This will allow us to issue <b>health cards</b> which will allow you to work in cafes, restaurants, and cinemas.
  </div>
  ...
  <div
     style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;line-height:24px;text-align:left;color:#000000;"
  >
    As a part of that process we're required to ask if your mother is a Kuwaiti national. Please update your profile with an answer so we can better assist you in finding a job.
  </div>
  ...
  >
    <tr>
      ...
      >
        <a
           href="<?= $url ?>" style="background:#4354A4;color:white;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:16px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
        >
          Update my profile
        </a>
