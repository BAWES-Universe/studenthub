...
<head>
    <title>
        KD <?= number_format($totalPaidToCandidate,3) ?> transferred to your account!
    </title>
    <!--[if !mso]><!-- -->
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <tr>
                                                <td
                                                    align="center" style="font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:25px;word-break:break-word;"
                                                >
                                ...
                                >
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="" style="vertical-align:top;width:638px;"
                                            >
                                    <![endif]-->
                                        ...
                                        >
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:24px;font-weight:normal;line-height:24px;text-align:center;color:#000000;"
                                                    >
                                                        IT'S TIME <?= $name ?> 🤑
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:28px;font-weight:bold;line-height:24px;text-align:center;color:#000000;"
                                                    >
                                                        KD <?= number_format($totalPaidToCandidate,3) ?>
                                                    </div>
                                            ...
                                            <tr>
                                                <td
                                                    align="center" style="font-size:0px;padding:1px;word-break:break-word;"
                                                >

                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:21px;font-weight:normal;line-height:24px;text-align:center;color:#000000;"
                                                    >
                                                    ...
                                                    >
                                                        ...
                                                        <tr>
                                                            <td  style="width:588px;">
                                                                ...
                                                                <img
                                                                    height="auto" src="<?= $imageMoney ?>" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="588"
                                                                />
