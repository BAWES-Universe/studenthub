...
return [
	...
	'in {delta, plural, =1{a day} other{# days}}' => 'في {delta, plural, =1{ يوم } other{# أيام}}',
	'in {delta, plural, =1{a minute} other{# minutes}}' => 'في {delta, plural, =1{ دقيقة } other{# الدقائق}}',
	'in {delta, plural, =1{a month} other{# months}}' => 'في {delta, plural, =1{ شهر } other{# الشهور }}',
	'in {delta, plural, =1{a second} other{# seconds}}' => 'في {delta, plural, =1{ ثانية } other{# ثواني }}',
	'in {delta, plural, =1{a year} other{# years}}' => 'في {delta, plural, =1{ سنة } other{# سنوات}}',
	'in {delta, plural, =1{an hour} other{# hours}}' => 'في {delta, plural, =1{ ساعة } other{# ساعات }}',
	'{delta, plural, =1{a day} other{# days}} ago' => '{delta, plural, =1{ يوم } other{# أيام }} منذ',
	'{delta, plural, =1{a minute} other{# minutes}} ago' => '{delta, plural, =1{ دقيقة } other{# الدقائق }} منذ',
	'{delta, plural, =1{a month} other{# months}} ago' => '{delta, plural, =1{ شهر } other{# الشهور }} منذ',
	'{delta, plural, =1{a second} other{# seconds}} ago' => '{delta, plural, =1{ ثانية } other{# ثواني }} منذ',
	'{delta, plural, =1{a year} other{# years}} ago' => '{delta, plural, =1{ سنة } other{# سنوات }} منذ',
	'{delta, plural, =1{an hour} other{# hours}} ago' => '{delta, plural, =1{ ساعة } other{# ساعات }} منذ',
