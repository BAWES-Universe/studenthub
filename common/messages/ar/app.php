...
return [
    ...
    "Salary" => "مرتب",
    "Comment" => "تعليق",
    'Request Checklist Uuid' => 'طلب قائمة Uuid',
    "Status Name" => 'اسم الحالة',
    'Status Name Ar' => 'اسم الحالة - عربي',
    'Is Require' => 'هل تتطلب',
    'Sort Order' => 'امر ترتيب',
    'Request started at' => 'بدأ الطلب في',
    'Request assigned at' => 'طلب معين في',
    'Request delivered at' => 'تم تسليم الطلب في',
    'Request cancelled at' => 'تم إلغاء الطلب في',
    'Fulltimer employed?' => 'هل تعمل بدوام كامل؟',
    'Role' => 'دور',
    'Consultant' => 'مستشار',
    ...
    'Bonus Commission' => 'عمولة المكافآت ',
    ...
    "Fulltimer Tags ID" => "معرف علامة Fulltimer",
    "Fulltimer Uuid" => "Fulltimer Uuid",
    "Tag" => "بطاقة شعار",
    "Nationality ID" => "هوية الجنسية",
    "Fulltimer Area Uuid" => "Uuid منطقة Fulltimer",
    "Fulltimer Latitude" => "خط العرض Fulltimer",
    "Fulltimer Longitude" => "خط الطول Fulltimer",
    "Fulltimer Name" => "اسم Fulltimer",
    "Fulltimer Phone" => "هاتف Fulltimer",
    "Fulltimer Email" => "البريد الإلكتروني Fulltimer",
    "Fulltimer Pdf Cv" => "Fulltimer PDF السيرة الذاتية",
    "Fulltimer Created Datetime" => "إنشاء Fulltimer التاريخ والوقت",
    "Fulltimer Updated Datetime" => "تم تحديث Fulltimer Datetime",
    "Missing candidate" => "مرشح مفقود",
    "Suggestion Uuid" => "Uuid الاقتراح",
    "Request Uuid" => "طلب Uuid",
    "Note Uuid" => "لاحظ Uuid",
    "Suggestion Status" => "حالة الاقتراح",
    "Suggestion Datetime" => "تاريخ الاقتراح",
