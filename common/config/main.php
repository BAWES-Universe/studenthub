...
return [
    ...
    'components' => [
        'temporaryBucketResourceManager' => [
            ...
            'region' => getenv('AWS_S3_TEMP_REGION') ?: 'eu-west-2', // Bucket based in London
            'key' => getenv('AWS_S3_TEMP_ACCESS_KEY_ID') ?: '',
            'secret' => getenv('AWS_S3_TEMP_SECRET_ACCESS_KEY') ?: '',
            'bucket' => getenv('AWS_S3_TEMP_BUCKET') ?: 'studenthub-public-anyone-can-upload-24hr-expiry'
            /**
