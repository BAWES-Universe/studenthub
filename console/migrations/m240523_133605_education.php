...
/**
 * Class m240523_133605_education
 */
class m240523_133605_education extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->createTable("{{%degree_group}}", [
            "degree_group_uuid" => $this->char(60),
            "degree_group_name_en" => $this->string()->notNull(),
            "degree_group_name_ar" => $this->string(),
            'degree_group_sort_order' => $this->integer(3)->defaultValue(0),
            "skip_major" => $this->tinyInteger(),
            "degree_group_created_at" => $this->dateTime(),
            "degree_group_updated_at" => $this->dateTime()
        ], $tableOptions);

        $this->addPrimaryKey('PK', 'degree_group', 'degree_group_uuid');

        //degree

        $this->createTable("{{%degree}}", [
            "degree_uuid" => $this->char(60),
            "degree_group_uuid" => $this->char(60),
            'degree_name_en' => $this->string()->notNull(),
            'degree_name_ar' => $this->string(),
            'degree_sort_order' => $this->integer(3)->defaultValue(0),
            'degree_created_at' => $this->dateTime(),
            'degree_updated_at' => $this->dateTime()
        ], $tableOptions);

        $this->addPrimaryKey('PK', 'degree', 'degree_uuid');

        $this->createIndex(
            "idx-degree-degree_group_uuid",
            "degree",
            "degree_group_uuid"
        );

        $this->addForeignKey(
            "fk-degree-degree_group_uuid",
            "degree",
            "degree_group_uuid",
            "degree_group",
            "degree_group_uuid",
        ...
        $degree_group_uuid = Yii::$app->db->createCommand("select uuid()")->queryScalar();

        Yii::$app->db->createCommand()->insert("degree_group", [
            "degree_group_uuid" => $degree_group_uuid,
            "degree_group_name_en" => "Undergraduate Degrees",
            "degree_group_name_ar" => "شهادات دون مرحلة التخرج",
        ])->execute();

        Yii::$app->db->createCommand()->batchInsert(
            "degree",
            ["degree_uuid", "degree_group_uuid", "degree_name_en", "degree_name_ar", "degree_created_at", "degree_updated_at"],
            [
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Associate's Degree", "المنتسب درجة", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Bachelor of Arts (BA)", "ليسانس الآداب (بكالوريوس)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Bachelor of Business Administration (BBA)", "بكالوريوس في إدارة الأعمال (BBA)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Bachelor of Engineering (BEng)", "بكالوريوس هندسة (BEng)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Bachelor of Fine Arts (BFA)", "بكالوريوس في الفنون الجميلة (منتدى بواو لاسيا)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Bachelor of Science (BS)", "بكالوريوس العلوم (بكالوريوس)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Bachelor's Degree", "درجة البكالريوس", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Engineer's Degree", "درجة في الهندسة", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
            ])->execute();
        ...
        Yii::$app->db->createCommand()->insert("degree_group", [
            "degree_group_uuid" => $degree_group_uuid,
            "degree_group_name_en" => "Graduate Degrees",
            "degree_group_name_ar" => "الشهادات العليا"
        ])->execute();
        ...
        Yii::$app->db->createCommand()->batchInsert(
            ...
            ["degree_uuid", "degree_group_uuid", "degree_name_en", "degree_name_ar", "degree_created_at", "degree_updated_at"],
            [
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Master of Arts (MA)", "ماجستير في الآداب (ماجستير)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Master of Business Administration (MBA)", "ماجستير في إدارة الأعمال (ماجستير في إدارة الأعمال)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Master of Fine Arts (MFA)", "ماجستير في الفنون الجميلة (وزارة الخارجية)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Master of Science (MS)", "ماجستير العلوم (ماجستير)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Master's Degree", "ماجيستير", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Doctor of Philosophy (PhD)", "دكتور في الفلسفة (دكتوراه)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Doctor of Medicine (MD)", "دكتور في الطب (دكتوراه في الطب)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Juris Doctor (JD)", "دكتوراة (دكتوراه)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
            ])->execute();
        ...
        Yii::$app->db->createCommand()->insert("degree_group", [
            "degree_group_uuid" => $degree_group_uuid,
            "degree_group_name_en" => "Other",
            "degree_group_name_ar" => "آخر",
            "skip_major" => 1
        ])->execute();
        ...
        Yii::$app->db->createCommand()->batchInsert(
            ...
            ["degree_uuid", "degree_group_uuid", "degree_name_en", "degree_name_ar", "degree_created_at", "degree_updated_at"],
            [
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "High School Diploma", "شهادة الدراسة الثانوية", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Non-Degree Program (e.g. Coursera certificate)", "برنامج غير درجة (على سبيل المثال شهادة Coursera)", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")],
                [new \yii\db\Expression('uuid()'), $degree_group_uuid, "Other", "آخر", date("Y-m-d H:m:s"), date("Y-m-d H:m:s")]
            ])->execute();

        $this->createTable('{{%major}}', [
            'major_uuid' => $this->char(60),
            'major_name_en' => $this->string(150)->notNull()->unique(),
            'major_name_ar' => $this->string(150)->notNull()->unique(),
            'data_source' => $this->smallInteger(1)->comment('Student (1), Admin (0)'),
            'major_created_at' => $this->dateTime(),
            'major_updated_at' => $this->dateTime()
        ], $tableOptions);

        $this->addPrimaryKey('PK', 'major', 'major_uuid');
        ...
        $data = [
            ...
            [487, 'Architectural Engineering Technology/Technician', 'هندسة الهندسة المعمارية / فني'],
            ...
            [1381, 'Fine and Studio Arts', 'الفنون الجميلة والاستوديو'],
        ...
        foreach($data as $major) {
            $major[0] = new yii\db\Expression('uuid()');
        ...
        Yii::$app->db->createCommand()->batchInsert(
            '{{%major}}',
            ['major_uuid', 'major_name_en', 'major_name_ar'],
            $majors
        )->execute();

        Yii::$app->db->createCommand("SET foreign_key_checks = 1")->execute();

        $this->createTable('{{%candidate_education}}', [
            'education_uuid' => $this->char(60),
            'candidate_id' => $this->integer(11)->notNull(),
            'university_id' => $this->integer(11)->notNull(),
            'degree_uuid' => $this->char(60),
            "major_uuid" => $this->char(60),
            'graduation_year' => $this->integer(5),
            'is_currently_studying' => $this->boolean()->defaultValue(0),
            'created_at' => $this->dateTime(),
            'updated_at' => $this->dateTime(),
        ], $tableOptions);

        $this->addPrimaryKey('PK', 'candidate_education', 'education_uuid');

        $this->createIndex(
            'idx-candidate_education-candidate_id',
            'candidate_education',
            'candidate_id'
        );

        $this->addForeignKey(
            "fk-candidate_education-candidate_id",
            "candidate_education",
            "candidate_id",
            "candidate",
            "candidate_id"
        ...
        $this->createIndex(
            'idx-candidate_education-major_uuid',
            'candidate_education',
            'major_uuid'
        );

        $this->addForeignKey(
            "fk-candidate_education-major_uuid",
            "candidate_education",
            "major_uuid",
            "major",
            "major_uuid"
        ...
        $this->createIndex(
            'idx-candidate_education-degree_uuid',
            'candidate_education',
            'degree_uuid'
        );

        $this->addForeignKey(
            "fk-candidate_education-degree_uuid",
            "candidate_education",
            "degree_uuid",
            "degree",
            "degree_uuid"
        ...
        $this->createIndex(
            'idx-candidate_education-university_id',
            'candidate_education',
            'university_id'
        );

        $this->addForeignKey(
            "fk-candidate_education-university_id",
            "candidate_education",
            "university_id",
            "university",
            "university_id"
        ...
        //todo: move current university to education
    }
    ...
    {
        echo "m240523_133605_education cannot be reverted.\n";
