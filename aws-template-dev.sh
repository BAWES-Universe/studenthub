...
echo "
<VirtualHost *:80>
        ServerName inspector.api.dev.studenthub.co
...
echo "
<VirtualHost *:80>
        ServerName status.api.dev.studenthub.co
...
echo "
<VirtualHost *:80>
        ServerName employer.api.dev.studenthub.co
...
echo "
<VirtualHost *:80>
        ServerName student.api.dev.studenthub.co
...
echo "
<VirtualHost *:80>
        ServerName staff.api.dev.studenthub.co
...
echo "
<VirtualHost *:80>
        ServerName admin.api.dev.studenthub.co
