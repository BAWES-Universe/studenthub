...
return [
    'components' => [
        ...
        'urlManagerStaff' => [
            ...
            'baseUrl' => 'http://192.168.1.5:8888/bawes/studenthub/staff/web/v1'
        ],
        'urlManagerCandidate' => [
            'class' => 'yii\web\UrlManager',
            'enablePrettyUrl' => true,
        ...
        'urlManagerVerification' => [
            ...
            'enablePrettyUrl' => true,
            'showScriptName' => false,
            'baseUrl' => 'http://192.168.1.5:8888/studenthub/verification/web'
        ],
        'eventManager' => [
        ...
        'mediaConvert' => [
            ...
            'key' => getenv('AWS_MEDIACONVERT_ACCESS_KEY_ID') ?: getenv('AWS_MEDIACONVERT_RAILWAY_ACCESS_KEY_ID') ?: null,
            'secret' => getenv('AWS_MEDIACONVERT_SECRET_ACCESS_KEY') ?: getenv('AWS_MEDIACONVERT_RAILWAY_SECRET_ACCESS_KEY') ?: null,
