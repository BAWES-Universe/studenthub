...
class Transfer extends \common\models\Transfer {
     ...
     * @return $this
     */
    public function getChildTransferInvoices($modelClass = "\manager\models\Invoice")
    {
     ...
     * @return $this
     */
    public function getParentTransfer($modelClass = "\manager\models\Transfer")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getChildTransfers($modelClass = "\manager\models\Transfer")
    {
     ...
     * @return $this
     */
    public function getChildTransferCandidates($modelClass = "\manager\models\TransferCandidate")
    {
     ...
     */
    public function getUnPaidTransferCandidates($modelClass = "\manager\models\TransferCandidate")
    {
     ...
     * @return $this|\yii\db\ActiveQuery
     */
    public function getPaidTransferCandidates($modelClass = "\manager\models\TransferCandidate")
    {
     ...
     * @return $this
     */
    public function getParentTransferCandidates($modelClass = "\manager\models\TransferCandidate")
    {
