...
class Contact extends \common\models\Contact implements \yii\web\IdentityInterface {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getCompanyContactsHavingAccess($modelClass = "\manager\models\CompanyContact")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getManagedCompanies($modelClass = "\manager\models\Company")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getCompanies($modelClass = "\manager\models\Company")
    {
