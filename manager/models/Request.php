...
class Request extends \common\models\Request
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRequestCreatedBy($modelClass = "\manager\models\Staff")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRequestUpdatedBy($modelClass = "\manager\models\Staff")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getLastActivity($modelClass = "\manager\models\Note")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRequestActivities($modelClass = "\manager\models\Note")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getSuggestions($modelClass = "\manager\models\Suggestion") {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getActiveSuggestions($modelClass = "\manager\models\Suggestion") {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRequestCreatedByContact($modelClass = "\manager\models\Contact")
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRequestUpdatedByContact($modelClass = "\manager\models\Contact")
    {
